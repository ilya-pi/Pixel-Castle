...
public class GameState {
    ...
    private Map<StateName, Set<Transition>> toStates;

    public GameState(StateName name, Map<StateName, Set<Transition>> toStates) {
        this.name = name;
    ...
    public Set<Transition> getTransitions(StateName toState) {
