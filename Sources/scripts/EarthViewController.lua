...
--[[    for i=0,game.level_map.levelWidth do
		for l=0,game.level_map.levelHeight do
			...
			if (r == 255 and g == 0 and b == 255 and a == 255) then
				local castleY = game.level_map.levelHeight - l
				if (self.castleCount == 1) then
					...
					game.castle1:render(physics, game.world, game, i - 1, castleY)
				elseif (self.castleCount == 2) then
					...
					game.castle2:render(physics, game.world, game, i - 1, castleY)
				end
